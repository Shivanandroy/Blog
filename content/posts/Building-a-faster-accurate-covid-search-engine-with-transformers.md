...
### 🥳 Voila! We're Done.
Let's see, how well our search engine works! - Foe simplicity, we will keep the number of documents to be retrieved to 2 using `top_k_reader` parameter. But we can extend to any number in production.
